...
flags.DEFINE_string(
    "output_dir", "./tmp/lm_output_10000",
...
flags.DEFINE_string(
    "init_checkpoint", "/Users/trinhgiang/Downloads/multi_cased_L-12_H-768_A-12/bert_model_10000.ckpt",
...
def read_examples(input_file):
    ...
    examples = []
    unique_id = 0
    f = tf.gfile.GFile(input_file, "r")

    for line in f:
        sentence = tokenization.convert_to_unicode(line)
        sentence = sentence.strip()
        unique_id += 1
        examples.append(InputExample(unique_id, sentence))
        # unique_id += 1
...
def main(_):
    ...
    output_predict_file = os.path.join(FLAGS.output_dir, "test_results_sentence.json")
