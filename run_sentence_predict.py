...
flags.DEFINE_string(
    "output_dir", "./tmp/lm_output_20000",
...
flags.DEFINE_string(
    "init_checkpoint", "/Users/trinhgiang/Downloads/multi_cased_L-12_H-768_A-12/bert_model_20000.ckpt",
...
def read_sentences(sentences):
    ...
    for sentence in sentences:
        examples.append(InputExample(unique_id, sentence.strip()))
        unique_id += 1
...
def get_sentence_predict(sentences: str):
    ...
    output_predict_file = os.path.join(FLAGS.output_dir, "sentence_break_1.json")
...
sentences = ['website giới thiệu về cơ sở vật chất và đội ngũ y bác sĩ cũng như giới thiệu về các dịch vụ chăm sóc sức khỏe của phòng khám']
print(get_sentence_predict(sentences))
